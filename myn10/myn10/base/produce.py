...
for i in range(1,11):
	...
	peer1 = 'peer1.org' + str(i) + '.example.com'
	port0 = port_base + (i-1)*2000
	port1 = port_base + (i-1)*2000 + 1000
	datapeer0 ={
	    peer0 : { 
	...
	datapeer1 ={
	    peer1 : { 
	    	...
	    	'extends':{ 'file': 'peer-base.yaml', 'service': 'peer-base'},
	    	'environment' : ['CORE_PEER_ID=' + peer1, 
	    					'CORE_PEER_ADDRESS=' + peer1 +':7051',
	    					'CORE_PEER_GOSSIP_BOOTSTRAP=' + peer0 +':7051',
	    					'CORE_PEER_GOSSIP_EXTERNALENDPOINT=' + peer1 + ':7051',
	    					'CORE_PEER_LOCALMSPID=Org'+ str(i) +'MSP'],
	    	'volumes' : ['/var/run/:/host/var/run/', 
	    					'../crypto-config/peerOrganizations/org'+str(i) +'.example.com/peers/'+ peer1 +'/msp:/etc/hyperledger/fabric/msp',
	    					peer1 +':/var/hyperledger/production'],
	    	'ports' : [str(port1)+':7051', str(port1+2) +':7053']
	    	}
	}
