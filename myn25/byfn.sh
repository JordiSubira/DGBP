...
function generateChannelArtifacts() {
  ...
  set -x
  configtxgen -profile TwoOrgsChannel -outputAnchorPeersUpdate \
  ./channel-artifacts/Org8MSPanchors.tx -channelID $CHANNEL_NAME -asOrg Org8MSP
  res=$?
  set +x
  if [ $res -ne 0 ]; then
  ...
  set -x
  configtxgen -profile TwoOrgsChannel -outputAnchorPeersUpdate \
  ./channel-artifacts/Org9MSPanchors.tx -channelID $CHANNEL_NAME -asOrg Org9MSP
  res=$?
  set +x
  if [ $res -ne 0 ]; then
    echo "Failed to generate anchor peer update for Org9MSP..."
    exit 1
  fi
  echo
  ...
  set -x
  configtxgen -profile TwoOrgsChannel -outputAnchorPeersUpdate \
  ./channel-artifacts/Org10MSPanchors.tx -channelID $CHANNEL_NAME -asOrg Org10MSP
  res=$?
  set +x
  if [ $res -ne 0 ]; then
    echo "Failed to generate anchor peer update for Org10MSP..."
    exit 1
  fi
  echo
  ...
  set -x
  configtxgen -profile TwoOrgsChannel -outputAnchorPeersUpdate \
  ./channel-artifacts/Org11MSPanchors.tx -channelID $CHANNEL_NAME -asOrg Org11MSP
  res=$?
  set +x
  if [ $res -ne 0 ]; then
    echo "Failed to generate anchor peer update for Org10MSP..."
  ...
  set -x
  configtxgen -profile TwoOrgsChannel -outputAnchorPeersUpdate \
  ./channel-artifacts/Org12MSPanchors.tx -channelID $CHANNEL_NAME -asOrg Org12MSP
  res=$?
  set +x
  if [ $res -ne 0 ]; then
    echo "Failed to generate anchor peer update for Org10MSP..."
  ...
  set -x
  configtxgen -profile TwoOrgsChannel -outputAnchorPeersUpdate \
  ./channel-artifacts/Org13MSPanchors.tx -channelID $CHANNEL_NAME -asOrg Org13MSP
  res=$?
  set +x
  if [ $res -ne 0 ]; then
    echo "Failed to generate anchor peer update for Org10MSP..."
  ...
  set -x
  configtxgen -profile TwoOrgsChannel -outputAnchorPeersUpdate \
  ./channel-artifacts/Org14MSPanchors.tx -channelID $CHANNEL_NAME -asOrg Org14MSP
  res=$?
  set +x
  if [ $res -ne 0 ]; then
    echo "Failed to generate anchor peer update for Org10MSP..."
  ...
  set -x
  configtxgen -profile TwoOrgsChannel -outputAnchorPeersUpdate \
  ./channel-artifacts/Org15MSPanchors.tx -channelID $CHANNEL_NAME -asOrg Org15MSP
  res=$?
  set +x
  if [ $res -ne 0 ]; then
    echo "Failed to generate anchor peer update for Org10MSP..."
  ...
  set -x
  configtxgen -profile TwoOrgsChannel -outputAnchorPeersUpdate \
  ./channel-artifacts/Org16MSPanchors.tx -channelID $CHANNEL_NAME -asOrg Org16MSP
  res=$?
  set +x
  if [ $res -ne 0 ]; then
    echo "Failed to generate anchor peer update for Org10MSP..."
  ...
  set -x
  configtxgen -profile TwoOrgsChannel -outputAnchorPeersUpdate \
  ./channel-artifacts/Org17MSPanchors.tx -channelID $CHANNEL_NAME -asOrg Org17MSP
  res=$?
  set +x
  if [ $res -ne 0 ]; then
    echo "Failed to generate anchor peer update for Org10MSP..."
  ...
  set -x
  configtxgen -profile TwoOrgsChannel -outputAnchorPeersUpdate \
  ./channel-artifacts/Org18MSPanchors.tx -channelID $CHANNEL_NAME -asOrg Org18MSP
  res=$?
  set +x
  if [ $res -ne 0 ]; then
    echo "Failed to generate anchor peer update for Org10MSP..."
  ...
  set -x
  configtxgen -profile TwoOrgsChannel -outputAnchorPeersUpdate \
  ./channel-artifacts/Org19MSPanchors.tx -channelID $CHANNEL_NAME -asOrg Org19MSP
  res=$?
  set +x
  if [ $res -ne 0 ]; then
    echo "Failed to generate anchor peer update for Org10MSP..."
  ...
  set -x
  configtxgen -profile TwoOrgsChannel -outputAnchorPeersUpdate \
  ./channel-artifacts/Org20MSPanchors.tx -channelID $CHANNEL_NAME -asOrg Org20MSP
  res=$?
  set +x
  if [ $res -ne 0 ]; then
    echo "Failed to generate anchor peer update for Org10MSP..."
  ...
  set -x
  configtxgen -profile TwoOrgsChannel -outputAnchorPeersUpdate \
  ./channel-artifacts/Org21MSPanchors.tx -channelID $CHANNEL_NAME -asOrg Org21MSP
  res=$?
  set +x
  if [ $res -ne 0 ]; then
    echo "Failed to generate anchor peer update for Org10MSP..."
  ...
  set -x
  configtxgen -profile TwoOrgsChannel -outputAnchorPeersUpdate \
  ./channel-artifacts/Org23MSPanchors.tx -channelID $CHANNEL_NAME -asOrg Org23MSP
  res=$?
  set +x
  if [ $res -ne 0 ]; then
    echo "Failed to generate anchor peer update for Org10MSP..."
  ...
  set -x
  configtxgen -profile TwoOrgsChannel -outputAnchorPeersUpdate \
  ./channel-artifacts/Org24MSPanchors.tx -channelID $CHANNEL_NAME -asOrg Org24MSP
  res=$?
  set +x
  if [ $res -ne 0 ]; then
    echo "Failed to generate anchor peer update for Org10MSP..."
  ...
  set -x
  configtxgen -profile TwoOrgsChannel -outputAnchorPeersUpdate \
  ./channel-artifacts/Org25MSPanchors.tx -channelID $CHANNEL_NAME -asOrg Org25MSP
  res=$?
  set +x
  if [ $res -ne 0 ]; then
    echo "Failed to generate anchor peer update for Org10MSP..."
