...
setGlobals () {
	...
	if [ $ORG -eq 1 ] ; then
		...
		CORE_PEER_TLS_ROOTCERT_FILE=/opt/gopath/src/github.com/hyperledger/fabric/peer/crypto/peerOrganizations/org3.example.com/peers/peer0.org12.example.com/tls/ca.crt
		...
		if [ $PEER -eq 0 ]; then
		 ...
		 CORE_PEER_MSPCONFIGPATH=/opt/gopath/src/github.com/hyperledger/fabric/peer/crypto/peerOrganizations/org13.example.com/users/Admin@org13.example.com/msp
		 CORE_PEER_ADDRESS=peer0.org13.example.com:7051
	elif [ $ORG -eq 14 ] ; then
		 CORE_PEER_LOCALMSPID="Org14MSP"
		 CORE_PEER_MSPCONFIGPATH=/opt/gopath/src/github.com/hyperledger/fabric/peer/crypto/peerOrganizations/org14.example.com/users/Admin@org14.example.com/msp
		 CORE_PEER_ADDRESS=peer0.org14.example.com:7051
	elif [ $ORG -eq 15 ] ; then
		 CORE_PEER_LOCALMSPID="Org15MSP"
		 CORE_PEER_MSPCONFIGPATH=/opt/gopath/src/github.com/hyperledger/fabric/peer/crypto/peerOrganizations/org15.example.com/users/Admin@org15.example.com/msp
		 CORE_PEER_ADDRESS=peer0.org15.example.com:7051
	elif [ $ORG -eq 16 ] ; then
		 CORE_PEER_LOCALMSPID="Org16MSP"
		 CORE_PEER_MSPCONFIGPATH=/opt/gopath/src/github.com/hyperledger/fabric/peer/crypto/peerOrganizations/org16.example.com/users/Admin@org16.example.com/msp
		 CORE_PEER_ADDRESS=peer0.org16.example.com:7051
	elif [ $ORG -eq 17 ] ; then
		 CORE_PEER_LOCALMSPID="Org17MSP"
		 CORE_PEER_MSPCONFIGPATH=/opt/gopath/src/github.com/hyperledger/fabric/peer/crypto/peerOrganizations/org17.example.com/users/Admin@org17.example.com/msp
		 CORE_PEER_ADDRESS=peer0.org17.example.com:7051
	elif [ $ORG -eq 18 ] ; then
		 CORE_PEER_LOCALMSPID="Org18MSP"
		 CORE_PEER_MSPCONFIGPATH=/opt/gopath/src/github.com/hyperledger/fabric/peer/crypto/peerOrganizations/org18.example.com/users/Admin@org18.example.com/msp
		 CORE_PEER_ADDRESS=peer0.org18.example.com:7051
	elif [ $ORG -eq 19 ] ; then
		 CORE_PEER_LOCALMSPID="Org19MSP"
		 CORE_PEER_MSPCONFIGPATH=/opt/gopath/src/github.com/hyperledger/fabric/peer/crypto/peerOrganizations/org19.example.com/users/Admin@org19.example.com/msp
		 CORE_PEER_ADDRESS=peer0.org19.example.com:7051
	elif [ $ORG -eq 20 ] ; then
		 ...
		 CORE_PEER_LOCALMSPID="Org21MSP"
		 CORE_PEER_MSPCONFIGPATH=/opt/gopath/src/github.com/hyperledger/fabric/peer/crypto/peerOrganizations/org21.example.com/users/Admin@org21.example.com/msp
		 CORE_PEER_ADDRESS=peer0.org21.example.com:7051
	elif [ $ORG -eq 22 ] ; then
		 CORE_PEER_LOCALMSPID="Org22MSP"
		 CORE_PEER_MSPCONFIGPATH=/opt/gopath/src/github.com/hyperledger/fabric/peer/crypto/peerOrganizations/org22.example.com/users/Admin@org22.example.com/msp
		 CORE_PEER_ADDRESS=peer0.org22.example.com:7051
	elif [ $ORG -eq 23 ] ; then
		 CORE_PEER_LOCALMSPID="Org23MSP"
		 CORE_PEER_MSPCONFIGPATH=/opt/gopath/src/github.com/hyperledger/fabric/peer/crypto/peerOrganizations/org23.example.com/users/Admin@org23.example.com/msp
		 CORE_PEER_ADDRESS=peer0.org23.example.com:7051
	elif [ $ORG -eq 24 ] ; then
		 CORE_PEER_LOCALMSPID="Org24MSP"
		 CORE_PEER_MSPCONFIGPATH=/opt/gopath/src/github.com/hyperledger/fabric/peer/crypto/peerOrganizations/org24.example.com/users/Admin@org24.example.com/msp
		 CORE_PEER_ADDRESS=peer0.org24.example.com:7051
	elif [ $ORG -eq 25 ] ; then
		 CORE_PEER_LOCALMSPID="Org25MSP"
		 CORE_PEER_MSPCONFIGPATH=/opt/gopath/src/github.com/hyperledger/fabric/peer/crypto/peerOrganizations/org25.example.com/users/Admin@org25.example.com/msp
		 CORE_PEER_ADDRESS=peer0.org25.example.com:7051
...
instantiateChaincode () {
	...
	if [ -z "$CORE_PEER_TLS_ENABLED" -o "$CORE_PEER_TLS_ENABLED" = "false" ]; then
                set -x
		peer chaincode instantiate -o orderer.example.com:7050 -C $CHANNEL_NAME -n mycc -l ${LANGUAGE} -v ${VERSION} -c '{"Args":["init"]}' -P \
		"AND('Org1MSP.peer','Org2MSP.peer','Org3MSP.peer','Org4MSP.peer','Org5MSP.peer','Org6MSP.peer','Org7MSP.peer','Org8MSP.peer','Org9MSP.peer','Org10MSP.peer','Org11MSP.peer','Org12MSP.peer','Org13MSP.peer','Org14MSP.peer','Org15MSP.peer','Org16MSP.peer','Org17MSP.peer','Org18MSP.peer','Org19MSP.peer','Org20MSP.peer','Org21MSP.peer','Org22MSP.peer','Org23MSP.peer','Org24MSP.peer', 'Org25MSP.peer')" >&log.txt
		res=$?
                set +x
	else
                set -x
...
chaincodeQuery () {
  ...
  do
     ...
     set -x
     peer chaincode query -C $CHANNEL_NAME -n mycc -c '{"Args":["queryUserByEID","0.0.0.0"]}' >&log.txt
	 res=$?
     set +x
